                ...
                <div class="w-lg-500px bg-body rounded shadow-sm p-10 p-lg-15 mx-auto">
                    ...
                    <form class="form w-100" action="/login" method="POST">
                        ...
                        <div class="text-center mb-10">
                            <!--begin::Title-->
                            <h1 class="text-dark mb-3">Users Login</h1>
                            <!--end::Title-->
                            <!--begin::Link-->
                        ...
                        <div class="text-center">
                            ...
                            <!--end::Separator-->
                            <!--begin::Google link-->
                            <a href="/login/create" class="btn btn-flex flex-center btn-light btn-lg w-100 mb-5">
                                <i class="fa fas fa-user-plus"></i>Create Data</a>
                            <!--end::Google link-->
                        </div>
                        <!--end::Actions-->
                    </form>
